Download source code here: http://webpages.uncc.edu/aatzache/ITCS6162/Project/StudentPrograms/MR_RandomForestExample.zip
...
4. Run the .jar file using your terminal or Putty using following command:
	...
	path-to-parameters-file path-to-ActionRules-Output Minimum-Support Minimum-Confidence
